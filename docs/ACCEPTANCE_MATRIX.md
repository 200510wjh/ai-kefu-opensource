...
证明系统基础能力：SaaS、知识库、网页客服、六个平台回复接口、历史上下文、回复链路演练、构建和脚本编译。
...
| 微信/企业微信/抖音/淘宝/拼多多/闲鱼渠道 | 回复接口和桌面窗口识别都覆盖六个平台 | `platform_reply_api`、`launcher_platform_guess`、`acceptance:real-platforms` |
